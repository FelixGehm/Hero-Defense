...
namespace emotitron.Network.NST.HealthSystem
{
	...
	public interface IVitals
	{
		...
		void SetVital(float value, int VitalIndex);
		void AddToVital(float value, int VitalIndex);

		Vital this[int healthStat] { get; }
	}
	...
	public class Vital
	{
		...
		[BitsPerRange(4, 10, true, "Max Network Value:", false)]
	...
	public class VitalDrawer : PropertyDrawer
	{
		public override void OnGUI(Rect r, SerializedProperty property, GUIContent label)
		{
			...
			inner.yMin += 17;
			inner.height = 16;
			EditorGUI.PropertyField(inner, property.FindPropertyRelative("absorbtion"));
