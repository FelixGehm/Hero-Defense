...
namespace emotitron.Network.NST
{
	...
	public interface INstPreInterpolate
	{
		void OnNstPreInterpolate();
	}

	public interface INstPostInterpolate
	{
		void OnNstPostInterpolate();
	}
	...
	public interface INstBitstreamInjectFirst
	{
		...
		void NSTBitstreamIncomingFirst(Frame frame, Frame currFrame, ref UdpBitStream bitstream, bool isServer, bool waitingForTeleportConfirm);
		void NSTBitstreamMirrorFirst(Frame frame, ref UdpBitStream outstream, bool isServer, bool waitingForTeleportConfirm);
	}
	...
	public interface INstTeleportIncoming
	{
